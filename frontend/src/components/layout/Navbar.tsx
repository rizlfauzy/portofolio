...
export default memo(function Navbar() {
  ...
  return (
    <nav className="fixed w-full z-50 bg-white/20 dark:bg-gray-900/20 backdrop-blur-sm border-b border-gray-200/30 dark:border-gray-800/30 transition-colors">
