    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
      ...
      >
        ...
        <div
          ...
          style={{ backgroundImage: `url(${carouselImages[activeImageIndex]})` }}
        >
        ...
        <button
          ...
          className="absolute z-20 left-3 top-1/2 -translate-y-1/2 rounded-md px-3 py-2 bg-gray-900/30 dark:bg-gray-100/10 text-gray-100 dark:text-gray-100 hover:bg-gray-900/40 dark:hover:bg-gray-100/20 transition-colors"
        >
          ‹
        </button>
        <button
          ...
          className="absolute z-20 right-3 top-1/2 -translate-y-1/2 rounded-md px-3 py-2 bg-gray-900/30 dark:bg-gray-100/10 text-gray-100 dark:text-gray-100 hover:bg-gray-900/40 dark:hover:bg-gray-100/20 transition-colors"
        >
          ›
        </button>
